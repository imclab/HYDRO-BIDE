...
"""  The figure generated by code at the bottom serves to help reveal
     how total abundance, resources, dormancy, and activity respond to
     changes in Volume, inflow rate, density of resources flowing in,
     and the density of propagules immigrating, and the expected portion
     of active individuals among propagules. On to the model..."""
